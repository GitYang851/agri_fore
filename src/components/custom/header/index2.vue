<template>
  <div class="header">
    <div class="container">
      ...
      <div class="middle">
        <router-link class="nav-link" :class="{ active: $route.path === '/home' }" to="/"
          >首页</router-link
        >
        <router-link
          class="nav-link"
          ...
          >查询</router-link
        >
        <router-link class="nav-link" :class="{ active: $route.path === '/cart' }" to="/cart"
          >购物车</router-link
        >
        <router-link class="nav-link" :class="{ active: $route.path === '/order' }" to="/order"
          >订单</router-link
        >
      </div>
      <div class="right">
